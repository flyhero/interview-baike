	...
	<div class="land">
		<div>
			<div class="landBox" v-show="landing">
				...
				<span>{{ msg }}</span>
				<div class="account">
					<AutoComplete id="accountR" v-model="land.account" @on-search="handleInput" placeholder="输入账号邮箱">
				...
				<div style="display: flex;">
					<div style="margin: 0px auto;">
						<a :href="github" style="font-size: 24px;">
							<Icon type="logo-github" size="24px" />
						</a>
					</div>
				</div>
				<div>
